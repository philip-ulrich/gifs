...
You can also [fork](https://github.com/philip-ulrich/gifs/fork) this repository to your own account, and have your own gif library. Once you fork to your own account, you can even host your own GH Pages site ([like mine](http://gifs.ulrich.life/)) by editing or removing the [CNAME](https://github.com/philip-ulrich/gifs/blob/gh-pages/CNAME) file in your fork accordingly.
